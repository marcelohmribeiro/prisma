defmodule ProjetoPrismaWeb.UserAuth do
  ...
  @remember_me_cookie "_projeto_prisma_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ProjetoPrismaWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def require_sudo_mode(conn, _opts) do
    if Accounts.sudo_mode?(conn.assigns.current_scope.user, -10) do
      ...
      conn
      |> put_flash(:error, "Voce precisa se autenticar novamente para acessar esta pagina.")
